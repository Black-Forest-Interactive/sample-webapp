...
micronaut {
    ...
    processing {
        incremental(false)
        annotations("de.blackforrestdevelopment.sample.webapp.*")
    }
    aot {
...
application {
    mainClass.set("de.blackforrestdevelopment.sample.webapp.SampleWebApplication")
}

jib {
    from.image = "eclipse-temurin:21-jre-alpine"
    to {
        image = "iee1394/sample-webapp"
